...
async function main() {
  ...
  const products = [
    ...
    { title: 'Electric Sonic Toothbrush', description: 'Rechargeable, 5 brushing modes, 2-minute timer.', price: 75.00, compareAtPrice: 99.00, imageUrl: 'https://images.unsplash.com/photo-1609840114035-3c981b782dfe?q=80&w=1000&auto=format&fit=crop', categoryId: beautyId, quantity: 45 },
    { title: 'Beard Grooming Kit', description: 'Includes oil, balm, brush, and scissors for men.', price: 38.00, compareAtPrice: 50.00, imageUrl: 'https://images.unsplash.com/photo-1620916297397-a4a5402a3c6c?q=80&w=1000&auto=format&fit=crop', categoryId: beautyId, quantity: 35 },
